...
title = Label(entries_frame, text="Employee Management System", font=("Calibri", 18, "bold"), bg="black", fg="yellow")
...
btnAdd = Button(btn_frame, command=add_employee, text="Add Details", width=15, font=("Calibri", 16, "bold"), fg="gold",
...
tree_frame = Frame(root, bg="lightgrey")
tree_frame.place(x=0, y=480, width=1366, height=520)
style = ttk.Style()
